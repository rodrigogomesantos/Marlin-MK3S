...
#define STRING_CONFIG_H_AUTHOR "Rods" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 98.12
  #define DEFAULT_bedKi 19.01
  #define DEFAULT_bedKd 337.60
...
//#define CLASSIC_JERK
  ...
  //#define TRAVEL_EXTRA_XYJERK 4.5     // Additional jerk allowance for all travel moves
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_MIN_POS+252
