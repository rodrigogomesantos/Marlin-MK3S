...
#define HOMING_BUMP_MM      { 0, 0, 2 }  //{ 5, 5, 2 }       // (mm) Backoff from endstops after first bump
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.015       // (steps or mm) Steps or millimeter distance for each Z babystep
 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
    ...
    #define X_CURRENT_HOME  600 //X_CURRENT  // (mA) RMS current for sensorless homing
